    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-emerald-50 dark:from-gray-900 dark:to-emerald-900/10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl mb-24 border border-emerald-100 dark:border-emerald-900/20"
        >
          <h2 className="text-3xl font-bold mb-10 text-center">
            Detailed <span className="text-emerald-600">Feature Comparison</span>
          </h2>
              ...
              <tbody>
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-center">{feature.elite}</td>
                  </motion.tr>
                ))}
              </tbody>
            </table>
        ...
        {selectedPackage && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-2xl overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
              <div className={`h-48 bg-gradient-to-r ${selectedPackage.color} relative`}>
                <button 
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <p>Perfect for {selectedPackage.bestFor}</p>
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="flex items-end mb-6">
                  ...
                  <div className="text-gray-500 ml-2">/{selectedPackage.duration}</div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Button 
                    size="lg"
                    className="py-6 text-lg bg-gradient-to-r from-emerald-600 to-teal-500 hover:from-emerald-700 hover:to-teal-600"
                    onClick={triggerConfetti}
                  >
                  ...
                  <Button 
                    variant="outline"
                    size="lg"
                    className="py-6 text-lg border-emerald-500 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20"
                  >
                ...
                <div className="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700">
                  <div className="flex items-center bg-amber-50 dark:bg-amber-900/10 p-4 rounded-xl mb-4">
                    <Gift className="h-5 w-5 text-amber-600 dark:text-amber-400 mr-2" />
                    <span>Limited Time Offer: Get 1 month free when you pay for 3 months!</span>
                  </div>
                  
                  <div className="flex items-center">
                    <ShieldCheck className="h-5 w-5 text-emerald-600 dark:text-emerald-400 mr-2" />
